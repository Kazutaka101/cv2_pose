...
while True:
    ...
    if passedTime < 1:
        cv2.putText(img,"3",(100,440),cv2.FONT_HERSHEY_PLAIN,40,(0,0,255),40)   
    elif passedTime < 2:
        cv2.putText(img,"2",(100,440),cv2.FONT_HERSHEY_PLAIN,40,(0,0,255),40)  
    elif passedTime < 3:
        cv2.putText(img,"1",(100,440),cv2.FONT_HERSHEY_PLAIN,40,(0,0,255),40) 
    elif passedTime < 4:
        cv2.putText(img,"START",(0,240),cv2.FONT_HERSHEY_PLAIN,12,(0,0,255),12) 
