...
#load face_imgs
face_images = [cv2.imread("./face_imgs/happy.png"),cv2.imread("./face_imgs/sad.png"),cv2.imread("./face_imgs/victory.png")]
for i in range(len(face_images)):
    face_images[i] = cv2.resize(face_images[i],(h,w))
    ...
    while cap.isOpened():
        ...
        try:
            ...
            if body_language_class == "Happy":
                ...
                image[0:h,0:w] = face_image[0:h,0:w]
                print("---face_img---")
                print(face_image.shape[0])
                print(face_image.shape[1])  
                print("")
                print("---image.shape")
                print(image.shape[0])
                print(image.shape[1])              
